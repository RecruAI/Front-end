		...
		<div className="flex place-content-center items-center h-screen">
			<div className="grid grid-cols-5 gap-28">
				<div className="grid col-span-2 p-6">
					<div className="font-bold text-4xl text-center mb-24">Welcome back!</div>
					<div className="mx-auto">
						<Input label="EMAIL OR LOGIN" id="login" type="text"></Input>
						<Input label="PASSWORD" id="password" type="password"></Input>
						<div className="flex items-center mt-1">
							<input type="checkbox" className="w-4 h-4 border rounded-lg"></input>
							<label className="mt-0.5 block ml-1 text-xs font-bold text-gray-600">Remember password</label>
						</div>
						...
						<div className="flex justify-between">
							...
							<div className="ml-1 mt-1  text-xs font-bold text-blue-600">Forgot your password?</div>
						</div>
					</div>
				</div>
				<div className="p-6 ">
				...
				<div className="grid col-span-2 p-6 ">
					<div className="">
						<div>
							<div className="font-bold text-4xl text-center">Lorem ipsum, sit amet dolores.</div>
						</div>
					</div>
				</div>
			</div>
